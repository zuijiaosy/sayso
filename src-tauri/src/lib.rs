...
pub fn run(cli_args: CliArgs) {
    ...
    let specta_builder = Builder::<tauri::Wry>::new()
        .commands(collect_commands![
            ...
            commands::voice::test_cloud_asr,
            commands::voice::update_cloud_asr_provider,
            commands::voice::update_glm_asr_settings,
            commands::voice::update_stepfun_asr_settings,
            ...
            commands::history::get_usage_days,
